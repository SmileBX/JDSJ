  ...
  >
    ...
    <div class="bottomicon" v-if="showModule!=='manySelect'">
      ...
      <ul class="messagelist" v-if="showModule==='message'">
        <scroll-view scroll-y @scrolltolower="loadMore" class="scroll_height">
          ...
          >
            <span
              ...
              @click.stop="editTerm(item.Id,item.Name)"
            >编辑</span>
            <van-cell-group>
        ...
        <li style="color:red" @click="addTeim">添加常用语</li>
      </ul>
      <!-- 表情 -->
  ...
  methods: {
    ...
    saveText() {
      ...
      const params = {
        ...
        let postUrl ='User/AddUser_word' ;
        if(this.editTermId){
          postUrl = 'User/EditUser_word';
          params.Id = this.editTermId;
        }
      post(
        postUrl,params
      ).then(res => {
